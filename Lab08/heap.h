...
*
* Returns   -1  if the heap already exists,
*            0  if couldn't allocate memory for the heap,
...
*
* Returns   -2  if the new cost is invalid,
*           -1  if the heap doesn't exists,
*            0  if given node doesn't exists,
